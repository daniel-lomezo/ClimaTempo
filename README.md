# DevGrid
For this application, which was proposed to me, I would make requests for an API and query weather information from a list of approximately 170 different cities. 
